...
Continue the original independent C control, as reviewed in audits/assessment-dependency-review.md and control-stage.md: 72 creators and 144 consumers, not extra or substitute A/B slots. The preparation review and its corrected partial-preparation guards pass; all 72 creators are prepared in control-list.tsv, unstarted at this update. After checkpointing the immutable control-schedule.tsv/digest, prompts and control-assignments, launch fresh creators with the scheduled model/effort and only their prompt paths. Metadata is outside creator context. S01/S05/S10 consumer banks reuse original independent cases; S03/S06/S09 are newly authored from raw business sources and under control_new_case_review. No C consumer staging helper exists yet; it must preserve artifacts and (for S06) native source state. All A/B-dependent stages remain blocked and must not be silently dropped. No product PR, main trial or release action has occurred.
