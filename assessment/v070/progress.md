...
- Frozen main: dee3866d35e43db5db480fc9f85166a8dcb1ec3b (v0.7.0). The separate improvement worktree contains only the unaccepted B3 authoring/review clarification in two locale files; rejected B1 and B2 are preserved as immutable evidence.
...
- H03 is the final ordinary development round, preregistered in development-round-3.md. Frozen B3 retains explicit target-core authoring and adds a reference to existing Process Description Design review in the evaluation Task. Both foundations and other product assets remain unchanged. All six fresh creators completed and pass pinned physical-format checks. Twelve fresh consumer applications and an independent source-fidelity review are underway; consult their explicit ledgers. Original creator inputs match their frozen hashes; reported scope/validation lapses remain disclosed in audits/dev3-creator-observation-limits.md. No behavioral improvement is accepted.
...
Additional diagnostic reserve (separate from base): at most 72 executions across at most three rounds. H01 and H02 have 48 completed and two retained incomplete executions, for 50 started. H03 reserves 18 more; four reserve slots remain unallocated. Completion, observation validity, business adequacy and Outcome achievement are distinct.
