...
- H03 is the final ordinary development round, preregistered in development-round-3.md. Frozen B3 retains explicit target-core authoring and adds a reference to existing Process Description Design review in the evaluation Task. Both foundations and other product assets remain unchanged. Independent semantic/locale review, all 70 manifest entries, local links and root checks pass the pre-creator gate. Six creators are prepared and unstarted at this update; twelve downstream applications are reserved. No behavioral improvement is accepted.
