"""Run the pinned physical-format validator on completed calibration artifacts."""
...
def main():
    ...
    results = []
    for trial in sorted((ROOT / "trials").glob("cal-*")):
    ...
    target = ROOT / "validation/calibration-format.json"
