# Recovery relay: control-use-087

This supplemental record preserves text retained in the successful completed-trial conversation after the workspace became unavailable (`409 environment_offline`). It is a relay from captured conversation evidence, not a claim about current filesystem bytes. No workflow command was rerun and no workspace or business tool was accessed during recovery.

## Recovered scope and provenance

- `answer.md`: recovered verbatim from the successful `apply_patch` payload that created `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/C-U087/answer.md`.
- `execution-note.md`: recovered verbatim from the successful creation `apply_patch` payload plus the later successful patch that added command 10, at `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/C-U087/execution-note.md`.
- Checkpoint work file: exact one-line JSON retained from the successful `cat work/reimbursement-rollup-2026-04-03_2026-04-09.checkpoint.json` output. Original path: `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/C-U087/work/reimbursement-rollup-2026-04-03_2026-04-09.checkpoint.json`.

## Unavailable or not claimed

- Current filesystem existence, current bytes, metadata, or hashes for the original files are unavailable and are not claimed.
- Any workspace files not reproduced below are not recovered by this relay.
- Separate stdout and stderr streams were not retained by the execution interface; the original execution note accurately says the interface returned combined command output.
- No hash for any original local file is asserted.
...
**Coverage:** 6 of 6 source entries examined across 2 incorporated pages; 4 entries qualified.
...
The final checkpoint is at `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/C-U087/work/reimbursement-rollup-2026-04-03_2026-04-09.checkpoint.json`. It records `complete: true`, `next_cursor: null`, 2 incorporated pages, and all 6 incorporated entry IDs.
```
...
## Recovered checkpoint work-file text
