...
Use the existing local state at `/workspace/scratch/a75c3a6d9076/D1-U010-booking-state-3zc_fceb/bookings.sqlite`; the local booking interface is `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/D1-U010/input/booking.py`. Do not initialize or replace that state. Any supporting recovery records should stay in `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/D1-U010/work`.
