...
Use the existing local state at `/workspace/scratch/a75c3a6d9076/D1-U012-booking-state-0kvoufxa/bookings.sqlite`; the local booking interface is `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/D1-U012/input/booking.py`. Do not initialize or replace that state. Any supporting recovery records should stay in `/workspace/scratch/a75c3a6d9076/alps-v070-assessment/consumers/D1-U012/work`.
