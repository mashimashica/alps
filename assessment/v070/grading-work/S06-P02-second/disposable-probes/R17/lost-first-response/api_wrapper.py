...
LOG = Path('/workspace/scratch/a75c3a6d9076/alps-v070-assessment/grading-work/S06-P02-second/disposable-probes/R17/lost-first-response/public-api-calls.jsonl')
LOSE_FIRST = True
MARKER = Path('/workspace/scratch/a75c3a6d9076/alps-v070-assessment/grading-work/S06-P02-second/disposable-probes/R17/lost-first-response/loss.marker')
