...
LOG = Path('/workspace/scratch/a75c3a6d9076/alps-v070-assessment/grading-work/S06-P02-second/disposable-probes/R63/empty-source/public-api-calls.jsonl')
LOSE_FIRST = False
MARKER = Path('/workspace/scratch/a75c3a6d9076/alps-v070-assessment/grading-work/S06-P02-second/disposable-probes/R63/empty-source/loss.marker')
