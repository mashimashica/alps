...
INSERT INTO "operations" VALUES('probe-before-commit','{"party_id":"crew-cedar","seats":2,"slot_id":"paper-lab-am"}','{"booking_id":"booking:probe-before-commit","party_id":"crew-cedar","request_key":"probe-before-commit","seats":2,"slot_id":"paper-lab-am","state":"confirmed"}');
CREATE TABLE slots (
