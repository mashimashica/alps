...
INSERT INTO "operations" VALUES('same-key','{"party_id":"crew-cedar","seats":2,"slot_id":"paper-lab-am"}','{"booking_id":"booking:same-key","party_id":"crew-cedar","request_key":"same-key","seats":2,"slot_id":"paper-lab-am","state":"confirmed"}');
CREATE TABLE slots (
