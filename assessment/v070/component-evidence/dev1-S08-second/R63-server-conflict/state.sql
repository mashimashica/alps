...
INSERT INTO "operations" VALUES('conflict','{"party_id":"original-party","seats":2,"slot_id":"paper-lab-am"}','{"booking_id":"booking:conflict","party_id":"original-party","request_key":"conflict","seats":2,"slot_id":"paper-lab-am","state":"confirmed"}');
CREATE TABLE slots (
