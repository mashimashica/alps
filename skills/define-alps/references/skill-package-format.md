...
|---|---|---|---|
| `define-alps` Package | [`SKILL.md`](../SKILL.md) | Authoritative Agent Skill representation | Governs the represented ALPS Definition Process. |
...
- Package ID, exact package version, and Skill name that form the complete logical identity
- Canonical Skill reference and its normalized complete logical identity
- Applicable Package Binding, selected Skill Package, and uniquely located authoritative Agent Skill representation
...
- Every mandatory canonical Skill reference must normalize to one complete logical identity and, through the applicable Package Binding, locate exactly one authoritative Agent Skill representation in the selected Skill Package.
