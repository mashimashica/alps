...
- Clarify Framework wording: state that Outcomes are the work's success conditions, treat *usually* as non-normative, restate subject-less instructions as explicit requirements or recommendations, limit full Outcome coverage to Activities describing the whole work, and prohibit silently converting unconfirmed or unmet conditions into success.
- Extend the work-system design principles with non-normative *can*/*could*, a definition of tool users, allocation by authority, information trustworthiness, cost, and latency, least access and authority, untrusted information as data, and a separate evaluation of whether the configuration respects applicable requirements, authority, and effect limits; correct the Japanese term for component and operation size.
