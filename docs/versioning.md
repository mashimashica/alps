...
An ALPS release includes the design Skills and their referenced principles and resources, localizations, validation scripts, and repository-level documentation and assets.
