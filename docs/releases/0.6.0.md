...
ALPS 0.6.0 focuses on designing and reviewing the meaning of work through a Process Description. The [Framework](https://github.com/mashimashica/alps/blob/v0.6.0/spec/process-framework.md) defines that meaning; the [Specification](https://github.com/mashimashica/alps/blob/v0.6.0/spec/ALPS-SPEC.md) maps it to Agent Skills.
